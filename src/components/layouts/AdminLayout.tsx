    ...
    entries: [
      {
        ...
        items: [
          { type: 'leaf', path: '/admin/settings/branding', label: 'Branding', icon: Palette },
          { type: 'leaf', path: '/admin/settings/features', label: 'Features', icon: ToggleLeft },
          { type: 'leaf', path: '/admin/settings/contact', label: 'Contact Info', icon: Phone },
          { type: 'leaf', path: '/admin/settings/paper-template', label: 'Paper Template', icon: Layers },
          { type: 'leaf', path: '/admin/settings/bank', label: 'Bank Accounts', icon: Landmark },
          { type: 'leaf', path: '/admin/settings/sms', label: 'SMS Templates', icon: FileCode },
          { type: 'leaf', path: '/admin/settings/backup', label: 'Backup & Restore', icon: HardDriveDownload },
        ],
      },
    ],
  },
